...
This will add the `icon` component to your output CSS, and will generate one variant for each icon. 
...
- `icon`: is the icon component base classname. 
...
<i class="icon is-star" style="color:#ffea66;font-size:20px;"></i>

<!-- Using helpers -->
<i class="icon is-star has-color-red-500 has-size-xl"></i>
```
