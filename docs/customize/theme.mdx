...
The `$theme` section of the **siimple** configuration is where you can define your colors, sizes, breakpoints, variants and more.
...
The following scales can be defined in the `$theme` section:

| Scale | CSS Properties |
|-------|----------------|
| `colors` | `color` |
| `backgrounds` | `background-color`, `border-color`, `border-top-color`, `border-left-color`, `border-bottom-color`, `border-right-color` |
| `fonts` | `font-family` |
