...
<div class="has-radius has-bg-white has-p-6 is-flex has-direction-column-mobile">
    <div class="has-radius has-bg-primary has-p-6 tablet:has-w-64 is-flex has-justify-center">
        <i class="icon-image has-text-white has-size-7"></i>
    </div>
