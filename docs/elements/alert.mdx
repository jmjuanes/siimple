...
Variants for this element can be defined in the `alerts` section of the variants configuration. Alerts will use the properties defined in `alerts.default` to style the default alert class. Additional fields defined in the `alerts` section will generate additional modifierts for the alert element.

```js
export default {
    variants: {
        alerts: {
            // These styles will be applied to the base '.alert' class
            default: {
