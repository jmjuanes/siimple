...
Variants for this element can be defined in the `columns` section of your theme configuration. Properties defined in the `columns.default` section will be applied to the base columns class:

```js
export default {
    columns: {
        // Will be applied to the base '.column' class
        default: {
            paddingTop: "0.75rem",
