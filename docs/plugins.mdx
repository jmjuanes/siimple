...
Plugins allows you to extend **siimple** adding more styles and components.

## Built-in plugins

We provide a set of official plugins bundled with the dist version of **siimple** and can be added to your project.
