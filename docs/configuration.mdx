...
You can read more about built-in plugins in the [plugins guide](/plugins).
...
| Flag | Description |
|------|-------------|
| `"use-root-styles"` | Add root styles to the `<html>` element. Default is `true`. |
...
You can define additional styles in the `$styles` section. Custom scales and breakpoints can be applied here.
