...
Scales can be used in styles and variants. Just provide a string with the scale key as the CSS property and **siimple** will automatically set this property with the value specified in the scale:
