...
Scales can be used in styles, variants and components. Just provide a string with the scale key as the CSS property and **siimple** will automatically set this property with the value specified in the scale:
