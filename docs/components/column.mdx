...
<div class="columns has-text-center">
    <div class="column">
        <div class="has-radius has-bg-blue-500 has-text-white has-p-2">Column 1</div>
    </div>
    <div class="column">
...
<div class="columns has-text-center">
    <div class="column is-two-thirds">
        <div class="has-radius has-bg-blue-500 has-text-white has-p-2">2/3</div>
    </div>
    <div class="column is-one-third">
        <div class="has-radius has-bg-blue-500 has-text-white has-p-2">1/3</div>
    </div>
</div>
```
