...
```html live=true centered=true color=white
<div class="has-bg-blue-500 has-text-center has-p-3 has-w-64 is-rounded is-clickable">
    Pointer
</div>
```
...
```html live=true centered=true color=white
<div class="has-bg-blue-500 has-text-center has-p-3 has-w-64 is-rounded is-not-allowed">
    Cursor disabled
</div>
```
...
```html live=true centered=true color=white
<div class="has-bg-blue-500 has-p-3 has-mx-2 has-w-24 is-rounded">1</div>
<div class="has-bg-blue-500 has-p-3 has-mx-2 has-w-24 is-rounded is-hidden">2</div>
<div class="has-bg-blue-500 has-p-3 has-mx-2 has-w-24 is-rounded">3</div>
```

Use `is-block` to generate a block-level element: 

```html live=true color=white
<span class="has-bg-blue-500 has-p-3 has-m-2 is-rounded is-block">1</span>
<span class="has-bg-blue-500 has-p-3 has-m-2 is-rounded is-block">2</span>
<span class="has-bg-blue-500 has-p-3 has-m-2 is-rounded is-block">3</span>
```

Use `is-inline-block` to generate an inline block element: 

```html live=true color=primary
<div class="has-bg-blue-500 is-rounded has-p-2">
...
```html live=true
<div class="is-aligned-left has-w-32 has-h-32 has-mr-8 has-bg-blue-500 is-rounded">
...
```html live=true
<div class="is-aligned-right has-w-32 has-h-32 has-ml-8 has-bg-blue-500 is-rounded">
    <div class="has-w-full has-h-full is-flex has-justify-center">
        <i class="si-image has-size-7 has-text-white"></i>
    </div>
</div>
...
<div class="is-scrollable has-h-32 has-maxw-64 has-p-6 has-bg-primary is-rounded">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
...
```html live=true color=white centered=true
<div class="is-clipped has-h-32 has-maxw-64 has-p-6 has-bg-primary is-rounded">
    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
    incididunt ut labore et dolore magna aliqua. 
    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut 
    aliquip ex ea commodo consequat.
