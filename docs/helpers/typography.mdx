...
| Class | Value |
|-------|----------|
| `has-font-body` | The font defined in the **body** field. By default it will apply `font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Ubuntu, "Noto Sans", "Helvetica Neue", Arial, sans-serif;`. |
| `has-font-heading` | The font defined in the **heading** field of your theme. By default it will apply `font-family: inherit;`. |
| `has-font-code` | The font defined in the **code** field of your theme. By default it will apply `font-family: Menlo, Monaco, Consolas, monospace;`. |
...
For each size defined in the `lineHeights` field of your theme, there will be a helper with the pattern `has-lh-{name}` to apply the specified line-height. The following line-height helpers will be always available:

| Class | Property |
|-------|----------|
| `has-lh-body` | The line-height for your body. In the default theme this helper will apply `line-height: 1.5;`. |
| `has-lh-heading` | The line-height for your headings. In the default theme this helper will apply `line-height: 1.25;`. |

Also, the following line-height helpers will be always included, regardless the values you provide in your theme configuration:
