...
//Global styles
//const baseClass = "siimple__splitpanel";
const verticalStyle = {
    "flex": "1",
    "flexDirection": "row",
    //"height": "100%",
...
const separatorVerticalStyle = {
    "width": `${separatorSize}px`,
    "height": "100%",
    "cursor": "col-resize"
};
const separatorHorizontalStyle = {
    "width": "100%",
...
export class SplitPanel extends React.Component {
    ...
    renderSeparator() {
        ...
        let style = (this.props.split === "vertical") ? separatorVerticalStyle : separatorHorizontalStyle; 
        //Return the separator element
        return React.createElement("div", {
            "className": self.props.resizeClassName,
            "style": style, //Object.assign({}, style, self.props.resizeStyle),
    ...
    render() {
        ...
        let style = (this.props.split === "vertical") ? verticalStyle : horizontalStyle;
        //Build the parent props
        let parentProps = {
            "style": style, //Object.assign({}, style, this.props.style),
            //"className": [baseClass, baseClass + "--" + this.props.split].join(" "),
            "className": classNames("has-flex has-h-full", this.props.className),
            "ref": this.ref.parent
        };
