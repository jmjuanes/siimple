...
<div className="columns has-py-none">
<div className="column is-two-fifths is-full-mobile has-py-none">
...
<div className="column is-three-fifths is-full-mobile has-py-none">
