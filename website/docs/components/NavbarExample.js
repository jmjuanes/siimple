...
export const NavbarExample = () => {
    ...
    return (
        <div className="has-mb-4 is-rounded has-bg-gray-100 has-p-6">
            <div className="container has-bg-white is-rounded has-p-6 is-flex has-items-center has-flex-wrap">
