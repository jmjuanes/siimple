...
export const Features = (props) => {
    return (
        <div className="content is-xlarge has-pt-12 has-pb-24">
            ...
            <div className="title is-1 has-mt-0 has-mb-8">
            ...
            <div className="columns has-mb-0">
                <ForEach items={data} render={(item, key) => (
                    <div key={key} className="column mobile:is-12 has-py-4">
                        ...
                        <div className="paragraph">{item.content}</div>
                        <div className="">
