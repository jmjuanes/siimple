...
docs: 
	...
	${NODE_BIN}/pngsprite --inputPNGFolder ./docs/_images/ --outputPNGFile ./docs/_site/assets/images/icons.png --cssIconSize 45 --cssOutput ./docs/_site/assets/css/icons.css --debug
